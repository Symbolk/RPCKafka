...
int Set_Light (int Valor_led_red, int Valor_led_yellow)
{
   digitalWrite(PIN_led_rojo, Valor_led_red);
   digitalWrite(PIN_led_amarillo, Valor_led_yellow);
}
